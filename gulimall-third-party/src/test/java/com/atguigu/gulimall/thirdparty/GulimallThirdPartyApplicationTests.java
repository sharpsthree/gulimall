...
//        OSS ossClient = new OSSClientBuilder().build(endpoint, accessKeyId, accessKeySecret);
        ...
        // 上传文件流。
        InputStream inputStream = new FileInputStream("/Users/crx/Downloads/2020电商/1-分布式基础_全栈开发篇/docs/pics/73ab4d2e818d2211.jpg");
        ossClient.putObject("gulimall-lubancantfly", "73ab4d2e818d2211.jpg", inputStream);
    ...
    public void sendCodeTest() {
        ...
        smsComponent.sendCode("13205009313", "666778");
