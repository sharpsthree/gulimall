...
public class BrandController {
    ...
    public R save(@Validated(value = {AddGruop.class}) @RequestBody BrandEntity brand){
...
//        }
    ...
    //@RequiresPermissions("product:brand:update")
    public R updateStatus(@Validated(value = {UpdateStausGroup.class}) @RequestBody BrandEntity brand){
